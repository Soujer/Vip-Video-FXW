...
<html>
	...
	<head>
		...
		<!--苹果桌面标题-->
		<meta name="apple-mobile-web-app-title" content="分享网VIP解析">
		<!--苹果桌面图标-->
	...
	<body>
			        ...
			        <span class="icon-bar"></span>
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li>
									<a href="http://www.fxw.la/" target="_blank">我爱分享网</a>
								</li>
								<li>
									<a href="http://www.fxw.la/vip/" target="_blank"> <span class="badge" style="background: red;margin-right:5px ;">NEW</span>分享网VIP解析<span class="sr-only">(current)</span></a>
								</li>
								<li>
									<a href="#">音乐盒</a>
								</li>
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li>
											<a href="http://www.fxw.la/" target="_blank" title="我爱分享网（www.fxw.la），互动笔记、原创教程、资源分享、疑难解答、最新技术，Web前端及爱好者提供一个信息交流、经验分享、互帮互助的平台">我爱分享网</a>
										</li>
										<li>
											<a href="<?php echo $aik['weibourl'];?>" target="_blank" title="分享网微博">分享网微博</a>
										</li>
										<li role="separator" class="divider"></li>
										<li>
											<a href="http://www.9258.me/" target="_blank" title="领取优惠券购物，不花冤枉钱">淘宝天猫优惠券</a>
										</li>
										<li>
											<a href="http://dh.fxw.la/" target="_blank">分享网导航</a>
										</li>
										
										<li>
											<a href="http://test.fxw.la/vip/" target="_blank">分享网影院</a>
										</li>
									</ul>
								</li>
								<li>
									<a href="http://www.fxw.la/app/" target="_blank">优惠券APP</a>
								</li>
							</ul>
						</div>
					</div>
		...
		<div class="container-fluid video-box">
			<div class="container ">
				<div class="tit-name">
					<span>正在播放:</span>
					<h1 id="tittext">感谢您使用分享网视频解析服务,正在播放音乐MV视频！</h1>
				</div>
