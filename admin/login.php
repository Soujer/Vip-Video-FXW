...
<body>
	...
	<ul>
		<li><a href="../">返回首页</a></li>
		<li><a href="http://www.fxw.la" target="_blank">开发者</a></li>
...
<tr class="header">
			<td colspan="4" align="center" style=" height:50px; font-size:18px; font-weight:bold;    background-color: #ecf1fc;">分享网影院系统登陆</td>
</tr>
