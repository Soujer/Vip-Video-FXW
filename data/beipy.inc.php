<?php
 $aik =  array (
  ...
  'weibourl' => 'https://weibo.com/soujer',
  'weibo' => '<iframe width="100%" height="550" style="border-radius: 5px;" class="share_self"  frameborder="0" scrolling="no" src="http://www.fxw.la/"></iframe>',
  'gonggao' => '若视频播放异常，尝试刷新或更换接口即可解决！',
  'gonggaourl' => 'http://www.fxw.la/',
...
<li>
	...
	<a  href="http://www.9258.me/" target="_blank" title="领取优惠券购物，不花冤枉钱">购BUY</a>

</li>


',
  'ch1' => '<a href="http://www.9258.me/" target="_blank" title="领券购物更优惠"><img src="img/gou.gif"/></a>',
...
<script type="text/javascript">
  ...
  'homelink' => '		<a href="http://www.fxw.la/" target="_blank"style="color:#888;margin:0 10px;">

			分享网官网

		</a>|

		<a href="http://www.fxw.la/vip/" target="_blank"style="color:#888;margin:0 10px;">

			北漂鱼影院

		</a>|

		<a href="http://www.fxw.la/" target="_blank"style="color:#888;margin:0 10px;">
